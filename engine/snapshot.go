...
type EngineState struct {
	...
	FlagsBegin  bool       `json:"flagsBegin"`
	FlagsDmy    bool       `json:"flagsDmy"`
	FlagsAngle  AngleMode  `json:"flagsAngle"`
	DispMode    DisplayMode `json:"dispMode"`
	DispDigits  int         `json:"dispDigits"`
}
...
func (e *Engine) Snapshot() EngineState {
	return EngineState{
		...
		FlagsBegin: e.Flags.Begin, FlagsDmy: e.Flags.Dmy,
		FlagsAngle: e.Flags.Angle,
		DispMode:   e.Flags.DispMode, DispDigits: e.Flags.DispDigits,
	}
}
...
func (e *Engine) Restore(s EngineState) {
	...
	e.Flags.Begin = s.FlagsBegin
	e.Flags.Dmy = s.FlagsDmy
	e.Flags.Angle = s.FlagsAngle
	e.Flags.DispMode = s.DispMode
	e.Flags.DispDigits = s.DispDigits
}
